...
public class PartRenderingEngine implements IPresentationEngine {
	public static final String engineURI = "bundleclass://at.bestsolution.efxclipse.runtime.workbench.swing/"
			+ "at.bestsolution.efxclipse.runtime.workbench.swing.PartRenderingEngine";

	private static final String defaultFactoryUrl = "bundleclass://at.bestsolution.efxclipse.runtime.workbench.renderers.swing/"
			+ "at.bestsolution.efxclipse.runtime.workbench.renderers.swing.DefWorkbenchRendererFactory";
...
//		}
	...
	public Object run(MApplicationElement uiRoot, IEclipseContext appContext) {
		...
		while( true ) {
			//FIXME Need to see at least one window is visible
			try {
				Thread.sleep(1000);
